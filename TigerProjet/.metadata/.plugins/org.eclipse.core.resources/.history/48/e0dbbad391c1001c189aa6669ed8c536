...
제1조(목적)
이 약관은 주식회사 바로입 회사(전자거래 사업자)가 운영하는 바로입 사이버 몰(이하 "몰"이라 한다)에서 제공하는 전자상거래 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
※ 「PC통신, 스마트폰 앱, 무선등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
① "몰"이란 주식회사 바로입 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
㈜팀프레시
개인 배송사업자(링크)
주식회사 카카오   카카오 알림톡 및 친구톡 전송 서비스
인포뱅크 주식회사   문자 발송 서비스
주식회사 루나소프트   스마트메시지(카카오 알림톡 및 친구톡, SMS/LMS/MMS 발송) 전송 서비스
스티비 주식회사   이메일 전송 서비스
...
업체명
(정보관리책임자 연락처)   이전 국가   이전 목적 및 업무 내용   이전되는 시점 및 방법   이전되는 개인정보   보유 및 이용 기간
Google LLC
(googlekrsupport@google.com)   미국   Google Cloud 서비스를 통한 시스템 관리   서비스 이용 시점에 네트워크를 통한 전송   바로입 서비스를 사용 (가입 및 상담, 결제) 하면서 수집·이용되는 개인정보   회원 탈퇴 시 또는 위탁계약 종료 시까지

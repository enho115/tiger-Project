	...
	<div class="row">
		...
		<div class="col-lg-4 text-left cs_02_02_box02">
			<form>
				...
				만족 <input type="radio" class="mypage_radiobox" name="chk_info"
					value="Moderately "> 보통 <input type="radio"
					class="mypage_radiobox" name="chk_info" value="dissatisfied">
				불만족 <input type="radio" class="mypage_radiobox" name="chk_info"
					value="Very dissatisfied"> 매우 불만족
	...
	<div class="row">
		...
		<div class="col-lg-4 text-left cs_02_02_box04">
			<div class="form-group">
				<textarea class="form-control" rows="8" placeholder="제목을 입력하세요."></textarea>
			</div>
